--tạo CSDL--
CREATE DATABASE CSDL QLBanghang
--tạp các bảng dữ liệu--
create table hangsx
(
...
--đưa ra thông tin vừa nhập --
select*from [CSDL QLBanghang].dbo.hangsx
select*from [CSDL QLBanghang].dbo.nhanvien
select*from [CSDL QLBanghang].dbo.nhap
select*from [CSDL QLBanghang].dbo.sanpham
select*from [CSDL QLBanghang].dbo.xuat
