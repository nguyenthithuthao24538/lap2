...
values ('NV01','Nguyễn Thị Thu','nữ','0982626521','thu@gmail.com','kế toán')
insert into nhanvien
values('NV02','Lê Văn Nam','nam','09722525252','nam@gmail.com','vật tư')
insert into nhanvien
values('NV03','Trần Hòa Bình','nữ','0328388388','hb@gmail.com','kế toán')

insert into sanpham
values ('SPV01','H02','F1 Plus','100','xám','7000000','chiếc','hang cận cao cấp')
insert into sanpham
values('SP02','H01','Galaxy Note 11','đỏ','19000000','chiếc','hàng cao cấp')
insert into sanpham
